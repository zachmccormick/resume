...
others. He currently works for Braze managing the Core Messaging Team, which is responsible for the underlying
frameworks and pipelines that send hundreds of millions of messages per day on behalf of Braze's customers..
...
\section{Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Braze}{New York, NY}
      {Engineering Manager/Sr. Engineering Manager - Messaging \& Automation Team}{Jun 2019 - Present}
       \resumeItemListStart
        \resumeItem{Engineering Management}
          {Led and grew the Messaging and Automation Team (5 to 10 direct reports).}
        \resumeItem{Organizational Involvement}
        ...
        \resumeItem{Continued Individual Execution}
          {Executed on a number of transformative or high-value projects requiring specialty knowledge or skills, such as implementing a job processing back-pressure system and deprecating "Original IAMs".}
        ...
        \resumeItem{Team Split}
          {Split the Messaging \& Automation Team into two teams: M\&A and Core Messaging, focusing CM on architecture, observability, performance, and documentation.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Messaging and Automation Team}
          {Created or enhanced high-frequency features of Braze's Messaging Pipeline, such as Frequency Capping, Rate/Volume Limiting, and "X Events in Y Time" Segmentation Rules.}
        \resumeItem{Platform Infrastructure Team}
